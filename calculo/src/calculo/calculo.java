...
{
	float result=(float)Math.sin(num);
	JOptionPane.showMessageDialog(null, "el seno de : "+Float.toString(num)+" es ="+Float.toString(result));
	
}

public void coseno(float num)
{
	float result=(float)Math.cos(num);
	JOptionPane.showMessageDialog(null, "el coseno de : "+Float.toString(num)+" es ="+Float.toString(result));
